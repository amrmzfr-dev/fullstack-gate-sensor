...
public interface IDeviceConfigStore
{
    ...
    Task<PositionConfig> GetPositionConfigAsync(CancellationToken cancellationToken);
    ...
    Task SetPositionConfigAsync(PositionConfig config, CancellationToken cancellationToken);
}
